            ...
            <div className="relative z-10 w-full max-w-md animate-fade-in">
                ...
                <div className="glass-panel border-white/10 p-8 rounded-2xl bg-black/40 backdrop-blur-xl shadow-2xl">
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <p className="text-muted-foreground text-sm mt-2">Sign in to continue your healthy journey</p>
                    </div>

                    <Button
                        variant="outline"
                        className="w-full mb-6 bg-white text-black hover:bg-gray-100 font-semibold h-11 border-none flex items-center gap-2 justify-center"
                        onClick={async () => {
                    ...
                    <div className="mt-6 text-center text-sm text-muted-foreground">
                        ...
                        <Link to="/register" className="text-white hover:underline transition-all">Sign up</Link>
                    </div>
                </div>
            </div>
        </div>
